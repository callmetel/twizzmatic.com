...
(function main($) {
   ...
   ******************************/
		...
		function changeSlide(slide) {
			...
			$(".slider-link").removeClass("animate__animated animate__fadeInUp animate__delay-1s");
			...
			nextSlide.find(".slider-link").addClass("animate__animated animate__fadeInUp animate__delay-1s");
		}
